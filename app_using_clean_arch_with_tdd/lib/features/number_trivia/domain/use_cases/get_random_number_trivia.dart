...
class GetRandomNumberTrivia extends UseCaseRegulation {
  NumberTriviaRepositoryContract numberTriviaRepositoryContract;

  GetRandomNumberTrivia({
    required this.numberTriviaRepositoryContract,
  });

  @override
  Future<Either<Failures, NumberTriviaEntity>?>? call({int? number}) async {
    return await numberTriviaRepositoryContract.getRandomNumberTrivia();
  }
}
